...
mocha_1.describe('v1.FirestoreClient', () => {
    ...
    mocha_1.describe('batchWrite', () => {
        mocha_1.it('invokes batchWrite without error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert(client.innerApiCalls.batchWrite
                .getCall(0)
                .calledWith(request, expectedOptions, undefined));
        });
        mocha_1.it('invokes batchWrite without error using callback', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        mocha_1.it('invokes batchWrite with error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    mocha_1.describe('partitionQuery', () => {
        mocha_1.it('invokes partitionQuery without error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert(client.innerApiCalls.partitionQuery
                .getCall(0)
                .calledWith(request, expectedOptions, undefined));
        });
        mocha_1.it('invokes partitionQuery without error using callback', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        mocha_1.it('invokes partitionQuery with error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        mocha_1.it('invokes partitionQueryStream without error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.strictEqual(client.descriptors.page.partitionQuery
                .createStream.getCall(0).args[2].otherArgs.headers['x-goog-request-params'], expectedHeaderRequestParams);
        });
        mocha_1.it('invokes partitionQueryStream with error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        mocha_1.it('uses async iteration with partitionQuery without error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.partitionQuery
                .asyncIterate.getCall(0).args[1], request);
            assert.strictEqual(client.descriptors.page.partitionQuery
                .asyncIterate.getCall(0).args[2].otherArgs.headers['x-goog-request-params'], expectedHeaderRequestParams);
        });
        mocha_1.it('uses async iteration with partitionQuery with error', async () => {
            const client = new firestoreModule.FirestoreClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
