...
mocha_1.describe('Order', () => {
    ...
    mocha_1.it('compares document snapshots by name', () => {
        const docs = [
        ...
        chai_1.expect(docs.map(doc => doc.id)).to.deep.eq([
            'doc1',
            'doc2',
            'doc2',
            'doc3',
            ...
            for (const left of groups[i]) {
                for (let j = 0; j < groups.length; j++) {
                    for (const right of groups[j]) {
                        ...
                        chai_1.expect(order.compare(left, right)).to.equal(expected, 'comparing ' +
                            left +
                            ' (' +
                            JSON.stringify(left) +
                            ') to ' +
                        ...
                        chai_1.expect(order.compare(right, left)).to.equal(expected, 'comparing ' +
                            right +
                            ' (' +
                            JSON.stringify(right) +
                            ') to ' +
